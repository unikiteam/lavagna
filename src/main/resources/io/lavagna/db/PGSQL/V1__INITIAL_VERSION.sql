...
ALTER TABLE LA_BOARD_COLUMN_DEFINITION ADD CONSTRAINT "BOARD_COLUMN_DEFINITION_VALUE" CHECK(BOARD_COLUMN_DEFINITION_VALUE IN ('OPEN', 'CLOSED', 'BACKLOG', 'DEFERRED', 'TAX', 'LEGAL', 'FINANCE', 'CLIENT', 'DONE'));
